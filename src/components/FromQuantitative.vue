<!-- 定量 -->
<template>
    <div class="from-name"  ref="fromQualitative" style="{height:heightNumer+'px'}">

        <template v-if="fileInput.length">
            <input type="file" v-for="item in fileInput" :key="item.id" :id="fileInputId" @change="handleFileChange"
                accept="image/*" multiple="multiple" />
        </template>
        <div ref = 'formName'>
        <el-form ref='ruleForm' :rules="formLabelAlignRules" :label-position="labelPosition" label-width="75px"
            :model="formLabelAlign">
            <el-row>
                <el-col :xs="12" :sm="12">
                    <el-form-item label="项目代码" prop="Characteristic" v-show="false">
                        <el-input v-model="formLabelAlign.Characteristic" readonly></el-input>
                    </el-form-item>
                </el-col>
                <el-col :xs="12" :sm="12">
                    <el-form-item label="标准值" prop="TargetValue">
                        <el-input v-model="formLabelAlign.TargetValue" readonly></el-input>
                    </el-form-item>
                </el-col>
                <el-col :xs="8" :sm="8">
            ...
            <el-row class="w40" :gutter="10">
                <el-col :xs="8" :sm="8">
                    <el-form-item label="上限" prop="UpperControlLimit">
                        <el-input v-model="formLabelAlign.UpperControlLimit" readonly></el-input>
                    </el-form-item>
                </el-col>
                <el-col :xs="8" :sm="8">
                    <el-form-item label="下限" prop="LowerControlLimit">
                        <el-input v-model="formLabelAlign.LowerControlLimit" readonly></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-form-item class="form-focus" label="项目描述" prop="CharacteristicText">
                ...
                <el-input type="textarea" readonly :autosize="{ minRows: 7, maxRows: 8 }"
            ...
            <el-row>
                <el-col :xs="12" :sm="12">
                    <el-form-item label="实测值" prop="TestValue"
                        :rules="[{ required: true, message: '请输入实测值', trigger: 'blur' }]">
                        <el-input v-model="formLabelAlign.TestValue" :disabled='isOrderFleg'></el-input>
                    </el-form-item>
                </el-col>
                <el-col :xs="12" :sm="12">
                    <el-form-item label="检验判定" prop="TestAttribute">
                        <el-input readonly v-model="formLabelAlign.TestAttribute"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-form-item class="imagesList" label="图片" prop="imgfileList"
                ...
                <div class="upload-demo-list">
                    <div v-if="imgfileList.length < 30 && !isOrderFleg"  v-loading="imgLoading"
                        class="el-upload el-upload--picture-card el-upload--picture-card-imgs" @click="imgLoading?'':openGallery()">
            ...
            <div class="el-form-item__label is-required">问题描述</div>
                <el-row class="dynamic-item" :gutter="10" v-for="(item, index) in RemarkList" :key="index">
                    ...
                    <el-col :xs="4" :sm="4">
                        <i @click="remarkListClick(index)" style="width: 100%; height: 100%; line-height: 40px;  font-size: 24px;" class="action-col"
        ...
        <div class="btn-list">
            ...
            <el-button v-if="!isOrderFleg" type="primary" :loading="loadingTrue" @click="submitForm('next')">保存并继续</el-button>
        ...
        formLabelAlign: {
            handler(data) {
                if (data.TestValue === 0 || data.TestValue) {
                    console.log(data.LowerControlLimit <= data.TestValue && data.UpperControlLimit >= data.TestValue)
                    if (data.LowerControlLimit <= data.TestValue && data.UpperControlLimit >= data.TestValue) {
