        ...
        <div class="headerInfo-row">
            <div class="headerInfo-row-left">
                <div class="line-height" @click="$emit('SelectStation')">
                    <div class="title-bg">{{ showSpecialConfiguration ? '当前工位' : '' }}
                        <div style="white-space: nowrap;"> {{ selectStationData.wrokStation || '点击选择工位' }}</div>
                    </div>
                    <div class="title-bg" style="background-color:#f4f4f5;color:#2c3e50"
                        v-if="showSpecialConfiguration">机型编码
                        <div style="white-space: nowrap;"> {{ stationData.ProductNo }}</div>
                    </div>
                </div>
            </div>
            <div class=" headerInfo-row-right input-box border-left" :span="15" :lg="15">
                <el-form ref='ruleForm' label-width="65px" :model="formLabelAlign">
                        ...
                        <el-input v-model="formLabelAlign.WipOrderNo">
                            <div slot="append">
                                <el-button @click="seach('WipOrderNo')">
                                    <svg t="1735261568655" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg" p-id="8288" width="15" height="15">
                                        <path
                                            ...
                                            fill="#5D5D5D" p-id="8289"></path>
                                    </svg>
                                </el-button>
                                <el-button @click="onCamera('WipOrderNo')" v-if="isApp">
                                    <svg t="1735261528500" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg" p-id="8122" width="15" height="15">
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#5D5D5D" p-id="8126"></path>
                                        <path
                                            d="M75.167468 486.152309l877.007181 0 0 51.587935-877.007181 0 0-51.587935Z"
                                            fill="#5D5D5D" p-id="8127"></path>
                                    </svg>
                                </el-button>
                            </div>
                        </el-input>
                    </el-form-item>
                    <el-form-item v-if="showSpecialConfiguration" label="月顺序号" prop="MonthSequence">
                    ...
                    <el-form-item v-if="showSpecialConfiguration" label="车架号" prop="Vin">
                        <el-input v-model="formLabelAlign.Vin">
                            <div slot="append">
                                ...
                                <el-button @click="onCamera('Vin')" v-if="isApp"><svg t="1735261528500" class="icon"
                                        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        p-id="8122" width="15" height="15">
                                        <path
                                            d="M900.583644 150.827147l0 206.341508 51.588959 0 0-232.137011c0-56.423057-51.588959-51.574632-51.588959-51.574632L668.437423 73.457012l0 51.574632 206.351742 0C874.789165 125.031645 900.583644 125.839033 900.583644 150.827147z"
                                            fill="#5D5D5D" p-id="8123"></path>
                                        <path
...
export default {
    ...
    methods: {
        ...
        seach(name) {
            ...
            if (this.formLabelAlign.WipOrderNo || this.formLabelAlign.MonthSequence || this.formLabelAlign.Vin) {
